    ...
    <table class="invoice-table">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right">RM{{ number_format($invoice->unit_price, 2) }}</td>
        ...
        <div class="totals">
            ...
            @if($invoice->deposit_amount > 0)
                <div class="total-row">
                    ...
                    <span>RM{{ number_format($invoice->deposit_amount, 2) }}</span>
                </div>
                <div class="total-row final">
                    <span>Balance Due:</span>
                    <span>RM{{ number_format($invoice->balance_amount, 2) }}</span>
                </div>
            @endif
        </div>
    </div>
