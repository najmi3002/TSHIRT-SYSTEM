...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="rounded-md ring-1 ring-pastel-purple ring-opacity-50 bg-pastel-gray <?php echo e($contentClasses); ?>">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\tshirt-system\tshirt-system\resources\views/components/dropdown.blade.php ENDPATH**/ ?>