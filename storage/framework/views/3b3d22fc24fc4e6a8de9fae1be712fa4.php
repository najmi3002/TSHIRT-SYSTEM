...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight font-sans">
            <?php echo e(__('Own Design')); ?>

        </h2>
     <?php $__env->endSlot(); ?>
    <div x-data="designForm({
        collars: <?php echo e(json_encode($collarOptions)); ?>,
        fabrics: <?php echo e(json_encode($fabricOptions)); ?>,
        sleeves: <?php echo e(json_encode($sleeveOptions)); ?>

    })" class="py-12 font-sans bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full flex justify-center my-4 px-4">
                <div class="w-full max-w-screen-2xl bg-gradient-to-br from-white via-gray-50 to-gray-200 shadow-xl rounded-2xl p-6">
                    <div class="flex justify-center mb-6">
                        <button @click="showDesignModal = true" class="bg-blue-600 text-white font-bold py-2 px-6 rounded shadow hover:bg-blue-800 transition">
                            Your Design
                        </button>
                    </div>
                    <h3 class="text-2xl font-extrabold mb-6 text-gray-800">Your Own Design Selections</h3>
                    <?php if(session('success')): ?>
                        <div class="mb-6 text-green-600 font-semibold"><?php echo e(session('success')); ?></div>
                    <?php endif; ?>
                    <div class="overflow-x-auto sm:overflow-x-visible">
                        <table class="w-full bg-white border border-gray-300 rounded-xl">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $designs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-4 py-2 border border-black text-center"><?php echo e($design->id); ?></td>
                                        <td class="px-4 py-2 border border-black">
                                            <?php echo e($design->product_name ?? ($design->product->name ?? 'Custom Design')); ?>

                                            <?php if($design->design_path): ?>
                                                <a href="<?php echo e(asset('storage/' . $design->design_path)); ?>" target="_blank" class="text-blue-500 text-xs block">(View Design)</a>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-2 border border-black">
                                            <ul class="list-disc list-inside">
                                                <?php $__empty_2 = true; $__currentLoopData = $design->collar_type ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        ...
                                        <td class="px-4 py-2 border border-black">
                                            <ul class="list-disc list-inside">
                                                <?php $__empty_2 = true; $__currentLoopData = $design->fabric_type ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <li><?php echo e($item['name']); ?> (<?php echo e($item['quantity']); ?>)</li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                    <li>-</li>
                                                <?php endif; ?>
                                        ...
                                        <td class="px-4 py-2 border border-black">
                                            <ul class="list-disc list-inside">
                                                <?php $__empty_2 = true; $__currentLoopData = $design->sleeve_type ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <li><?php echo e($item['name']); ?> (<?php echo e($item['quantity']); ?>)</li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                    <li>-</li>
                                                <?php endif; ?>
                                        ...
                                        <td class="px-4 py-2 border border-black text-center"><?php echo e($design->total_qty); ?></td>
                                        <td class="px-4 py-2 border border-black text-center"><?php echo e(number_format($design->total_price, 2)); ?></td>
                                        <td class="px-4 py-2 border border-black text-center">
                                            <?php $depositAmount = $design->total_price / 2; ?>
                                            <?php if($design->deposit): ?>
                                                <?php echo e(number_format($design->deposit, 2)); ?>

                                                <?php if($design->deposit_proof_path): ?>
                                                    <a href="<?php echo e(asset('storage/' . $design->deposit_proof_path)); ?>" target="_blank" class="text-blue-500 text-xs">(View Proof)</a>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <span class="font-semibold">RM <?php echo e(number_format($depositAmount, 2)); ?></span>
                                                <button @click="openModal('deposit', <?php echo e($design->id); ?>, <?php echo e($depositAmount); ?>)" class="bg-blue-500 text-black px-2 py-1 rounded text-xs ml-2">Pay Deposit</button>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-2 border border-black text-center">
                                            <?php if($design->deposit): ?>
                                                <?php $fullPayment = $design->total_price - $design->deposit; ?>
                                                <?php if($design->fullpayment): ?>
                                                    <?php echo e(number_format($design->fullpayment, 2)); ?>

                                                    <?php if($design->fullpayment_proof_path): ?>
                                                        <a href="<?php echo e(asset('storage/' . $design->fullpayment_proof_path)); ?>" target="_blank" class="text-blue-500 text-xs">(View Proof)</a>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <span class="font-semibold">RM <?php echo e(number_format($fullPayment, 2)); ?></span>
                                                    <button @click="openModal('fullpayment', <?php echo e($design->id); ?>, <?php echo e($fullPayment); ?>)" class="bg-green-500 text-white px-2 py-1 rounded text-xs ml-2">Pay Full</button>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-4 py-2 border border-black text-center"><?php echo e(ucfirst($design->status)); ?></td>
                                        <td class="px-4 py-2 border border-black text-center">
                                            <?php if($design->invoice): ?>
                                                <a href="<?php echo e(route('invoices.show', $design->invoice->id)); ?>" class="text-white bg-blue-500 hover:bg-blue-700 px-2 py-1 rounded text-xs font-bold">
                                                    View
                                                </a>
                                            <?php else: ?>
                                        ...
                                        <td class="px-4 py-2 border border-black text-center">
                                            ...
                                            ?>
                                            <a href="https://wa.me/<?php echo e($adminPhone); ?>?text=<?php echo e($defaultMessage); ?>" target="_blank" class="text-green-600 hover:underline font-bold">Chat</a>
                                        </td>
                                        <td class="px-4 py-2 border border-black text-center"><?php echo e($design->created_at->format('Y-m-d H:i')); ?></td>
                                        <td class="px-4 py-2 border border-black text-center">
                                            <form action="<?php echo e(route('designs.destroy', $design->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to cancel this design?');">
                                                <?php echo csrf_field(); ?>
                        ...
                        <div class="mt-2 px-7 py-3">
                            <div class="text-sm text-gray-500 text-left">
                                ...
                                <ul class="list-disc list-inside my-2">
                                    <li><strong>Bank:</strong> <?php echo e($bank_name); ?></li>
                                    <li><strong>Account Name:</strong> <?php echo e($account_name); ?></li>
                                    <li><strong>Account Number:</strong> <?php echo e($account_number); ?></li>
                                </ul>
                            </div>
                            <form action="<?php echo e(route('designs.payment.upload')); ?>" method="POST" enctype="multipart/form-data" class="mt-4">
                                <?php echo csrf_field(); ?>
            ...
            <div x-show="showDesignModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" style="display: none;">
                <div class="relative top-10 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-md bg-white">
                    <div class="mt-3">
                        ...
                        <form action="<?php echo e(route('designs.store.custom')); ?>" @submit="submitDesignForm" method="POST" enctype="multipart/form-data" class="space-y-6" x-ref="designForm">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\tshirt-system\tshirt-system\resources\views/designs/index.blade.php ENDPATH**/ ?>