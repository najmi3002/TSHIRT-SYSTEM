...
>
    ...
    >
        <div class="absolute inset-0 bg-pastel-purple/60 opacity-75"></div>
    </div>

    <div
        x-show="show"
        class="mb-6 bg-pastel-gray rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\xampp\htdocs\tshirt-system\resources\views/components/modal.blade.php ENDPATH**/ ?>