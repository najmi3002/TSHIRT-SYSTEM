            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-3">
                        <a href="<?php echo e(url('/admin/custom-design-types/edit')); ?>" class="bg-white border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-lg shadow-sm hover:bg-gray-50 transition-colors">
...
<?php endif; ?> <?php /**PATH C:\xampp\htdocs\tshirt-system\resources\views/admin/products.blade.php ENDPATH**/ ?>